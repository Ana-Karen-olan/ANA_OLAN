...
def test_task_five():
    # Inputs
    input_array = [
        '5',   # El primer argumento, que es la tarea
        '3',   # El segundo argumento, que es la cantidad de amigos
        'Gigi',  # Los amigos
        'Sam',
        'Jack'
    ]

    # Salida esperada (de acuerdo a lo que produce tu script Node.js)
    output_array = [
        "[ 'Gigi', 'Sami', 'Jack' ]"
    ]

    # Ejecuta la prueba con la función prepare_and_assert
    prepare_and_assert(input_array, output_array)
